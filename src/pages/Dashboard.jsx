    ...
    <div className="dashboard-shell">
      ...
      <aside className={menuOpen ? "sidebar active" : "sidebar"}>
        ...
        <nav className="sidebar-nav">
          ...
          <button className="nav-item" onClick={() => navigate("/departments")}>
            <FiGrid />
        ...
        <section className="stats-grid">
          <div className="stat-card purple">
            ...
            <div>
              <p>Total Employees</p>
              <h2>1,248</h2>
              <span className="up">↑ 12.5% from last month</span>
            </div>
          </div>
          ...
          <div className="stat-card blue">
            ...
            <div>
              <p>Present Today</p>
              <h2>1,102</h2>
              <span className="up">↑ 8.3% from yesterday</span>
            </div>
          </div>
          ...
          <div className="stat-card orange">
            ...
            <div>
              ...
              <h2>24</h2>
              <span className="down">↓ 4 from yesterday</span>
            </div>
          </div>
        </section>
        ...
        <section className="cards-grid">
          ...
          <div className="panel">
            <div className="panel-header">
              ...
              <button className="ghost-btn">This Month</button>
            </div>
